...
- Rural areas record 255.9K casualties, significantly higher than urban areas (162K).
- Night-time accidents lead to 305K casualties, much higher compared to daylight (112.9K), indicating visibility and driving behavior issues.
- Single carriageway roads have the maximum casualties (309.7K), showing infrastructure and traffic flow limitations.
...
## 🧠 Skills Demonstrated
  ...
  - Designing interactive dashboards using Pivot Charts, Slicers & Timelines
  - KPI metrics creation & Data summarization
...
## 🧰 Tools & Technologies
 ...
 - Microsoft Excel (Dashboard, Pivot Tables, Pivot Charts, Slicers)
